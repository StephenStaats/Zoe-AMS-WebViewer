...
HomeScreen.prototype.initializeAreas = function () {
   ...
   this.ETCO2ParamAreaBottom = this.bottomParamAreaTop - 1;
   this.ETCO2ParamAreaHeight = this.ETCO2ParamAreaBottom - this.ETCO2ParamAreaTop;

   this.FICO2ParamAreaWidth = this.middleParamAreaWidth;
   this.FICO2ParamAreaHeight = Math.round(this.ETCO2ParamAreaHeight / 2);
   ...
   this.RRCParamAreaHeight = Math.round(this.ETCO2ParamAreaHeight / 2);
   ...
   this.RRParamAreaHeight = Math.round(this.ETCO2ParamAreaHeight / 2);
   ...
   this.TEMPParamAreaTop = this.RRCParamAreaBottom + 1;
